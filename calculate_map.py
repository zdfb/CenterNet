...
class Calculate_mAP():
    def __init__(self):
        ...
        classes_path = 'model_data/voc_classes.txt'  # 类别信息存放路径
    ...
    def calculate_map(self):
        centernet = CenterNet()  # 实例化Centernet
        ...
        for image_id in tqdm(self.image_ids):  # 获取每张图像id
            ...
            centernet.get_map_txt(image_id, image, self.map_out_path)  # 获取预测结果并写入txt文件中
